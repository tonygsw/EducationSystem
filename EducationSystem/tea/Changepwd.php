            ...
            <div class="gtco-container">
                ...
                <div class="row">
                    <div class="col-sm-4 col-xs-12">
                        <div id="gtco-logo"><a href="../index.html">修改密码界面 <em>.</em></a></div>
                    </div>
                    ...
                    <div class="col-md-12 col-md-offset-0 text-left">
                        ...
                        <div class="row row-mt-15em">
                            <div class="col-md-7 mt-text animate1-box" data-animate1-effect="fadeInUp">
                                <span class="intro-text-small">Welcome to 修改密码界面</span>
                                <h1>身为湖大人,</h1>
                                <h1>敢为湖大事。</h1>
                            ...
                            <div class="col-md-4 col-md-push-1 animate1-box" data-animate1-effect="fadeInRight">
                                <div class="form-wrap">
                                    <div class="tab">
                                        <ul class="tab-menu">
                                            <li class="gtco-second"><a href="#" data-tab="login">Changepwd</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-content-inner active" data-content="signup">
                                                <form method="post"  action="../tea/Changepwd1.php">
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label for="teacher_password0">旧密码</label>
                                                            <input  name="teacher_password0" type="password" class="form-control" id="textfield">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label for="teacher_password1">新密码</label>
                                                            <input  name="teacher_password1" type="password" class="form-control" id="textfield2">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label for="teacher_password2">确认密码</label>
                                                            <input  name="teacher_password2" type="password" class="form-control" id="textfield2">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
