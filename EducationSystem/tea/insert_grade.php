            ...
            <div class="gtco-container">
                ...
                <div class="row">
                    <div class="col-sm-4 col-xs-12">
                        <div id="gtco-logo"><a href="../index.html">成绩录入界面 <em>.</em></a></div>
                    </div>
                    ...
                    <div class="col-md-12 col-md-offset-0 text-left">
                        ...
                        <div class="row row-mt-15em">
                            <div class="col-md-7 mt-text animate1-box" data-animate1-effect="fadeInUp">
                                <span class="intro-text-small">Welcome to 成绩录入界面</span>
                                <h1>分分分,</h1>
                                <h1>学生的命根！</h1>
                                    ...
                                    <div class="tab">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-content-inner active" data-content="signup">
                                                <form method="post"  action="check_insert_grade.php">
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label for="class_no">班级</label>
                                                            <input  name="class_no" type="text" class="form-control" id="textfield0">
                                                            ...
                                                            <input  name="student_name" type="text" class="form-control" id="textfield4">
