...
<head>
    ...
    <meta name="description" content="管理员功能选择界面">
...
<div id="Whoarewe" class="content-section-b"  style="background-image: url(../img/img_10.jpg)">
    <div class="container">
        ...
        <div class="col-md-6 col-md-offset-3 text-center wrap_title">
            <h2>功能选择界面</h2>
            <p class="lead" style="margin-top:0">实事求是 敢为人先.</p>
        ...
        <div class="row">
            <div class="col-sm-4  wow fadeInDown text-center">
                ...
                <h3>院系老师增删</h3>
                <p class="lead">
                    <a href="a_addteacher.php">进行增操作</a>
                    <a href="a_minusteacher.php">进行删操作</a>
                </p>
            ...
            <div class="col-sm-4 wow fadeInDown text-center">
                ...
                <h3>课程增删</h3>
                <p class="lead">
                    <a href="a_addcourse.php">进行增操作</a>
                    <a href="a_minuscourse.php">进行删操作</a>
                </p>
                <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
            </div><!-- /.col-lg-4 -->
