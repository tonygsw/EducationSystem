...
$AddCourse_SQL="insert into Course values($CouNo,$CouName,$Kind,intval($Credit),$Teacher,$SchoolTime,intval($LimitNum))";
$AddCourse_Result=db_query($con,$AddCourse_SQL);
