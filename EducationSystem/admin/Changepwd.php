                                            ...
                                            <div class="tab-content-inner active" data-content="signup">
                                                <form method="post"  action="Changepwd1.php">
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label for="admin_password0">旧密码</label>
                                                            <input  name="admin_password0" type="password" class="form-control" id="textfield">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label for="admin_password1">新密码</label>
                                                            <input  name="admin_password1" type="password" class="form-control" id="textfield2">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label for="admin_password2">确认密码</label>
                                                            <input  name="admin_password2" type="password" class="form-control" id="textfield2">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
