...
<div id="page">
    ...
    <div class="page-inner">
            ...
            <div class="gtco-container">
                ...
                <div class="row">
                    <div class="col-sm-4 col-xs-12">
                        <div id="gtco-logo"><a href="index.html">教师登录界面 <em>.</em></a></div>
                    </div>
        ...
        <header id="gtco-header" class="gtco-cover" role="banner" style="background-image: url(img/img_5.jpg)">
                    ...
                    <div class="col-md-12 col-md-offset-0 text-left">
                        ...
                        <div class="row row-mt-15em">
                            <div class="col-md-7 mt-text animate1-box" data-animate1-effect="fadeInUp">
                                <span class="intro-text-small">Welcome to 教师登录界面</span>
                                <h1>身为湖大人,</h1>
                                <h1>敢为湖大事。</h1>
                                                ...
                                                <form method="post"  action="check_login_teacher.php">
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input  name="teacher_password" type="password" class="form-control" id="textfield2">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
