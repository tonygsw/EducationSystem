                    ...
                    <div class="col-md-12 col-md-offset-0 text-left">
                        ...
                        <div class="row row-mt-15em">
                            <div class="col-md-7 mt-text animate1-box" data-animate1-effect="fadeInUp">
                                <span class="intro-text-small">Welcome to 登录界面</span>
                                <h1>身为湖大人,</h1>
                                <h1>敢为湖大事。</h1>
                                                ...
                                                <form method="post"  action="check_login_stuent.php">
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input  name="student_no" type="text" class="form-control" id="textfield">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label for="student_password">密码</label>
                                                            <input  name="student_password" type="password" class="form-control" id="textfield2">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                     <div class="col-md-12">
