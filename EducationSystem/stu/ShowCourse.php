...
<div class="intro-header">
    <div class="col-xs-12 text-center abcen1">
        <h3 class="h3_home wow fadeIn" data-wow-delay="0.4s">课表</h3>
        ...
        <table width="610" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr bgcolor="#0066CC">
                ...
                <td width="220" align="center"><a class="form-control">课程名称</a></td>
                <td width="50"><a class="form-control"  align="center">学分</a></td>
                <td width="80"><a class="form-control" align="center">任课教师编号</a></td>            </tr>
            <?php
