...
$Showclassmate_sql="SELECT * from student where student_no='$student_no';";
$ShowCourseResult=db_query($conn,$Showclassmate_sql);
$row=db_fetch_array($ShowCourseResult);
$class_no=$row['student_class'];
$Showclassmate_sql="SELECT * from grade where class_no='$class_no' GROUP BY student_no";
$ShowCourseResult=db_query($conn,$Showclassmate_sql);
?>
...
<div class="intro-header">
    <div class="col-xs-12 text-center abcen1">
        <h3 class="h3_home wow fadeIn" data-wow-delay="0.4s">同班同学</h3>
        <h3 class="h3_home wow fadeIn" data-wow-delay="0.6s">有你们，不孤单</h3>
        ...
        <table width="610" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr bgcolor="#0066CC">
                <td width="80" align="center"><a class="form-control">课程号</a></td>
                <td width="220" align="center"><a class="form-control">同学学号</a></td>
                <td width="220" align="center"><a class="form-control">他的姓名</a></td>
                <td width="220" align="center"><a class="form-control">他的成绩</a></td>
            </tr>
            <?php
            if(db_num_rows($ShowCourseResult)>0){
                ...
                for($i=0;$i<$number;$i++){
                    ...
                    if($i>=$p && $i < $check){
                        ...
                        echo"<td width='220'> <a class='h3_home wow fadeIn'>".$row['student_name']."</a></td>";
